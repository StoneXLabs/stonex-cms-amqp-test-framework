...
bool stonex::messaging::test::MockProtobufMessageSender::send_text(int msg_delay_ms)
{
	return false;
}
...
std::string stonex::messaging::test::MockProtobufMessageSender::createMessageBody()
{
