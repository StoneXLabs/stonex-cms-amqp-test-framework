...
stonex::messaging::test::MockProtobufMessageDecoratingSender::MockProtobufMessageDecoratingSender(const MessageDecoratingSenderConfiguration & config, CMSClientTestUnit & client_params, Notifier & parent)
	:MockMessageDecoratingSender(config, client_params, parent)
{
}

std::string stonex::messaging::test::MockProtobufMessageDecoratingSender::timeStamp() const
{
...
bool stonex::messaging::test::MockProtobufMessageDecoratingSender::send_bytes(int msg_delay_ms)
{
...
bool stonex::messaging::test::MockProtobufMessageDecoratingSender::send_stream(int msg_delay_ms)
{
	return false;
}

bool stonex::messaging::test::MockProtobufMessageDecoratingSender::send_map(int msg_delay_ms)
{
	return false;
}