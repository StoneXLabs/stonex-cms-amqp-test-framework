...
namespace stonex {
	namespace messaging {
		namespace test {
			...
			template <class T>
			class ProtobufMessageCountingDecoratingFileReceiver : public MessageCountingDecoratingFileReceiver
			{
			public:
				ProtobufMessageCountingDecoratingFileReceiver(const FileMessageCountingDecoratingReceiverConfiguration& config, CMSClientTestUnit & client_params, Notifier& parent)
					:MessageCountingDecoratingFileReceiver(config, client_params, parent)
				{
				}
